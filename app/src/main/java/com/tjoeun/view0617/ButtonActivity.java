...
public class ButtonActivity extends AppCompatActivity {
   //xml에 만들어진 뷰를 위한 변수
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //레이아웃 파일의 내용을 메모리에 로드해소 출력
        //레이아웃에 작성된 뷰 들의 설정은 이 메소드 호출 이후에 해야합니다.
        ...
        //체크박스의 이벤트 처리
        bold.setOnCheckedChangeListener(
                new CheckBox.OnCheckedChangeListener(){
                    //이벤트 처리 메소드의 첫번째 매개변수는
                    //이벤트가 발생한 객체입니다.
        ...
        colorradio.setOnCheckedChangeListener(
                new RadioGroup.OnCheckedChangeListener() {
                    //두번째 매개변수가 눌러진 RadioButton의 id
                    @Override
